...
// int FindMaxNum(size_t start, const int* nums, size_t size)
// {
//     size_t ret = start;
...
//     return ret;
// }
// void Swap(size_t left, size_t right, int* nums)
// {
//     int temp = nums[left];
...
// int main()
// {
//     // 假设我们有一个已经有数据的streambuf
//     std::streambuf* originalBuf = nullptr; // 获取原始streambuf

//     // 创建一个新的stringstream
//     std::stringstream ss;

//     // 将原始streambuf的内容复制到新的stringstream中
//     ss.rdbuf(originalBuf);
...
//     for (size_t i = 0; i < 10; ++i) {
//         size_t max_idx = FindMaxNum(i, nums, 10);
//         Swap(i, max_idx, nums);
//     }
//     return 0;
...
//     constexpr double number1 = 1.4*square(17);
//     int var = 10;
//     //constexpr double number2 = 1.4*square(var);

//     double number3 = 1.5*square(var);
//     if(int tt = var; tt > 10) {
//         cout << "if branch 1" << endl;
//     }
//     else if(tt < 10) {
//         cout << "if branch 2" << endl;
//     }
//     else {
//         cout << "if branch 3" << endl;
//     }

//     variant<double, int, char> union_test(888);
//     //union_test = 'c';
//     if(holds_alternative<int>(union_test)) {
//         cout << "there is a int:" << get<int>(union_test) << endl;
//     }
//     enum class Color{
//         RED, BLUE, GREEN
//     };
